...
namespace Tests\Unit\Controllers {
    ...
    class turn_activeTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_076_turn_active_sets_session_isActive_active_and_returns_json_0()
        {
            $this->setSession(['isActive' => 'nonActive']);

            $resp = (new AccountController())->turn_active();

            $this->assertInstanceOf(JsonResponse::class, $resp);
            $this->assertSame('active', session('isActive'));
            $this->assertSame(0, $this->decodeJsonResponse($resp));
        }
    }
}