...
namespace Tests\Feature {
    ...
    class cekAktifTest extends TestCase
    {
        use RefreshDatabase;
     ...
     * ========================= */
        ...
        public function test_UTB_001_cekAktif_inactive_returns_1()
        {
            $this->seedUser(['isActive' => 'nonActive']);
            $this->setSession(['user_id' => 2]);

            $res = (new AccountController())->cekAktif();
            $this->assertSame(1, json_decode($res->getContent(), true));
        }

        public function test_UTB_002_cekAktif_active_returns_0()
        {
