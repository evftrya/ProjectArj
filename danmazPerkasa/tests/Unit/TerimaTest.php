...
namespace Tests\Feature {
    ...
    class terimaTest extends BaseControllerTestCase
    {
     ...
     * ========================= */
        ...
        public function test_UTB_064_terima_sets_true()
        {
            ...
            $req = $this->makeRequest(['id_retur' => $idRetur], 'POST');
            (new ReturnPesananController())->terima($req);

            $this->assertDatabaseHas('return_pesanans', ['id' => $idRetur, 'retur_status' => 1]);
        }
    }
}