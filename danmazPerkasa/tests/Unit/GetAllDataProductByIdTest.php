...
namespace Tests\Unit\Controllers {
    ...
    class getAllDataProductByIdTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_109_getAllDataProductById_returns_json_response()
        {
            $this->requiresTablesOrSkip(['products', 'photos'], 'tables required');

            $pid = $this->seedProduct(['id_product' => 5, 'mainPhoto' => 1]);
            $this->seedPhoto(['id_Photo' => 1, 'id_product' => $pid, 'isMain' => 1]);

            $resp = (new ProductsController())->getAllDataProductById($pid);
