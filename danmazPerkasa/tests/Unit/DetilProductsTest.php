...
namespace Tests\Unit\Controllers {
    ...
    class DetilProductsTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_131_detilProducts_returns_view_for_customer_product_detail()
        {
            $this->mockAllViews();
            ...
            $this->seedProduct(['id_product' => 88, 'type' => 'Product']);
            $this->seedPhoto(['id_Photo' => 88, 'id_product' => 88]);
            DB::table('products')->where('id_product', 88)->update(['mainPhoto' => 88]);

            $resp = (new ProductsController())->DetilProducts(88);
            $this->assertStringContainsString('view:/User.Pelanggan.ProductDetil', (string)$resp->getContent());
        }
    }
}