...
namespace Tests\Unit\Controllers {
    ...
    class ManageTransactionTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_146_manageTransaction_returns_view_stub()
        {
            $this->mockAllViews();
            $this->seedAdmin();
            $this->setSession(['user_id' => 1, 'Role' => 'Admin']);

            $resp = (new TransaksiController())->ManageTransaction();
            $this->assertStringContainsString('view:User.Admin.ManageTransaction', (string)$resp->getContent());
        }
    }
}