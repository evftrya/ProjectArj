...
namespace Tests\Unit\Controllers {
    ...
    class CustomTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_142_custom_returns_outofpages_when_not_logged_in()
        {
            $this->mockAllViews();
            $this->setSession(['user_id' => null]);

            $resp = (new ProductsController())->Custom('T');
     ...
     * =========================================================== */
        ...
        public function test_TestCase_159_custom_returns_outofpages_when_not_logged_in()
        {
            $this->mockAllViews();
            $this->setSession(['user_id' => null]);
