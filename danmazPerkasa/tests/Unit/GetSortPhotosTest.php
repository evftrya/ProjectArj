...
namespace Tests\Unit\Controllers {
    ...
    class getSortPhotosTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_106_getSortPhotos_orders_photos_ascending()
        {
            ...
            $rows = (new PhotosController())->getSortPhotos($pid);

            $this->assertCount(3, $rows);
            $this->assertSame(1, (int)$rows[0]->id_Photo);
            $this->assertSame(2, (int)$rows[1]->id_Photo);
            $this->assertSame(3, (int)$rows[2]->id_Photo);
        }
    }
}