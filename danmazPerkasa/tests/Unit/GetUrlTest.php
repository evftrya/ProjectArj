...
namespace Tests\Unit\Controllers {
    ...
    class GetUrlTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_088_GetUrl_returns_first_segment_from_request_uri()
        {
            $_SERVER['HTTPS'] = 'off';
            $_SERVER['HTTP_HOST'] = 'example.test';
            $_SERVER['REQUEST_URI'] = '/Profile/Info?x=1';

            $seg = (new BaseController())->GetUrl();
            $this->assertSame('Profile', $seg);
        }
    }
}
