...
namespace Tests\Unit\Controllers {
    ...
    class ProductManageTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_127_productManage_returns_view_for_part_branch()
        {
            $this->mockAllViews();
            ...
            $resp = (new ProductsController())->ProductManage('Part');
            $this->assertStringContainsString('view:User.Admin.ManagePart', (string)$resp->getContent());
        }
     ...
     * =========================================================== */
        ...
        public function test_TestCase_160_productManage_returns_view_for_product_branch()
        {
            ...
            $resp = (new ProductsController())->ProductManage('Product');

            $this->assertStringContainsString('view:User.Admin.ManageProduct', (string)$resp->getContent());
        }
    }
}