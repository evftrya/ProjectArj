...
namespace Tests\Unit\Controllers {
    ...
    class getKecamatanTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_087_getKecamatan_returns_json_list_for_city()
        {
            $this->requiresTablesOrSkip(['kecamatans'], 'kecamatans table required');

            $pk = $this->pickColCI('kecamatans', ['kecamatan_id', 'id', 'id_kecamatan']);

            $row1 = [
                'city_id' => 10,
                'nama_kecamatan' => 'Alpha',
            ];
            $row2 = [
                'city_id' => 10,
                'nama_kecamatan' => 'Beta',
            ...
            $this->insertCaseSafe('kecamatans', $row1);
            $this->insertCaseSafe('kecamatans', $row2);

            $resp = (new AddressController())->getKecamatan(10);

            $this->assertInstanceOf(JsonResponse::class, $resp);
            $arr = $this->decodeJsonResponse($resp);
