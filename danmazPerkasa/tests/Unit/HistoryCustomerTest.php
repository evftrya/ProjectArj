...
namespace Tests\Unit\Controllers {
    ...
    class historyCustomerTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_116_historyCustomer_returns_view_stub_when_logged_in()
        {
            $this->requiresTablesOrSkip(['users', 'transaksis'], 'tables required');
            ...
            $resp = (new TransaksiController())->historyCustomer();
     ...
     * =========================================================== */
        ...
        public function test_TestCase_152_historyCustomer_returns_outofpages_when_not_logged_in()
        {
            $this->mockAllViews();
