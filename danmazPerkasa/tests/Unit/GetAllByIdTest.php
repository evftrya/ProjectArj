...
namespace Tests\Unit\Controllers {
    ...
    class getAllByIdTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_114_getAllById_returns_transactions_for_user()
        {
            $this->requiresTablesOrSkip(['users', 'transaksis'], 'tables required');

            $this->seedUser(['id_User' => 2, 'namaUser' => 'A B']);
            $this->seedTransaksi(['id' => 10, 'id_user' => 2]);

            $rows = (new TransaksiController())->getAllById(2);

            $this->assertNotEmpty($rows);
            $this->assertSame(10, (int)$rows[0]->id);
            $this->assertObjectHasProperty('Status_Transaksi', $rows[0]);
            $this->assertObjectHasProperty('Status_Pembayaran', $rows[0]);
        }
    }
}