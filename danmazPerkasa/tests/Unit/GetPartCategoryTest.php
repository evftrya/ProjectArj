...
namespace Tests\Unit\Controllers {
    ...
    class GetPartCategoryTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_128_getPartCategory_returns_rows()
        {
            $this->seedRefCategoryParts(1, 'Cat', 'Area', 'T');

            $rows = (new ProductsController())->GetPartCategory();
