...
namespace Tests\Unit\Controllers {
    ...
    class getAllDataPartByIdTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_110_getAllDataPartById_returns_json_response_for_part()
        {
            $this->requiresTablesOrSkip(
                ['products', 'photos', 'category_parts', 'ref_category_parts', 'ref_area_category_parts', 'ref_category_products'],
                'tables required'
            );
            ...
            $pid = $this->seedProduct(['id_product' => 5, 'type' => 'Part', 'mainPhoto' => 1]);
            $this->seedPhoto(['id_Photo' => 1, 'id_product' => $pid, 'isMain' => 1]);
            ...
            $resp = (new ProductsController())->getAllDataPartById($pid);
