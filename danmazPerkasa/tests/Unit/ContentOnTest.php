...
namespace Tests\Unit\Controllers {
    ...
    class ContentOnTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_137_contentOn_and_contentOff_wrapper_methods()
        {
            $this->seedProduct(['id_product' => 1371, 'isContent' => 0]);

            $r1 = (new ProductsController())->ContentOn(1371);
            $this->assertInstanceOf(JsonResponse::class, $r1);
            $this->assertSame(1, (int)DB::table('products')->where('id_product', 1371)->value('isContent'));

            $r2 = (new ProductsController())->ContentOff(1371);
            $this->assertInstanceOf(JsonResponse::class, $r2);
            $this->assertSame(0, (int)DB::table('products')->where('id_product', 1371)->value('isContent'));
        }
    }
}