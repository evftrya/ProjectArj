...
namespace Tests\Unit\Controllers {
    ...
    class searchTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_141_search_returns_view_with_search_param()
        {
            $this->mockAllViews();
            ...
            $this->seedProduct(['id_product' => 4101, 'type' => 'Product']);
            $this->seedPhoto(['id_Photo' => 4101, 'id_product' => 4101]);
            DB::table('products')->where('id_product', 4101)->update(['mainPhoto' => 4101]);

            $this->seedCategoryProducts(4101, 'T');

            $req = $this->makeRequest(['search' => 'abc'], 'POST');
            $resp = (new ProductsController())->search($req, 'T');
