...
namespace Tests\Unit\Controllers {
    ...
    class PaymentTransactionTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_149_paymentTransaction_returns_view_stub()
        {
            $this->mockAllViews();
            $resp = (new TransaksiController())->PaymentTransaction('snap-1');
            $this->assertStringContainsString('view:User.Pelanggan.Payment', (string)$resp->getContent());
        }
    }
}