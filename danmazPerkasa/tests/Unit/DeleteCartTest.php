...
namespace Tests\Unit\Controllers {
    ...
    class DeleteCartTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_100_DeleteCart_deletes_row_and_redirects_cart()
        {
            $this->requiresTablesOrSkip(['detail__transactions'], 'detail__transactions table required');

            $this->seedUser();
            $this->seedProduct();
            $this->seedDetailTransaction(['id_Detail_transaction' => 123]);

            $resp = (new DetailTransactionController())->DeleteCart(123);

            $this->assertInstanceOf(RedirectResponse::class, $resp);
            $this->assertFalse(DB::table('detail__transactions')->where('id_Detail_transaction', 123)->exists());
        }
    }
}