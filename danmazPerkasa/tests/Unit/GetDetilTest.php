...
namespace Tests\Unit\Controllers {
    ...
    class getDetilTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_086_getDetil_returns_detil_string_for_user()
        {
            $this->requiresTablesOrSkip(['users', 'addresses'], 'users/addresses table required');

            // FIX: seed user dulu agar FK addresses.id_user valid
            ...
            $detil = (new AddressController())->getDetil(2);
            $this->assertSame('Jl. A, Indonesia', $detil);
        }
    }
}