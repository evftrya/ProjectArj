...
namespace Tests\Unit\Controllers {
    ...
    class getProvinceTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_093_getProvince_returns_array_from_db()
        {
            $this->requiresTablesOrSkip(['provinces'], 'provinces table required');

            $this->insertCaseSafe('provinces', [
                'province_id' => 1,
                'province_name' => 'Jawa',
            ]);

            $resp = (new BaseController())->getProvince();
