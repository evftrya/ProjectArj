...
namespace Tests\Unit\Controllers {
    ...
    class manageUserTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_083_manageUser_returns_view_stub_with_data()
        {
            $this->requiresTablesOrSkip(['users', 'notifications'], 'users/notifications tables required');

            $this->mockViewHelper();
            $uid = $this->seedUser(['id_User' => 2]);
            $this->setSession(['user_id' => $uid]);

            $resp = (new AccountController())->manageUser();
