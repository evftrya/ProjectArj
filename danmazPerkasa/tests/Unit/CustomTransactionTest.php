...
namespace Tests\Unit\Controllers {
    ...
    class CustomTransactionTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_150_customTransaction_dash_branch_creates_and_redirects()
        {
            $this->mockAllViews();

            $this->requiresTablesOrSkip(['users', 'products', 'detail__transactions', 'transaksis'], 'tables required');
            ...
            $this->seedProduct(['id_product' => 8001, 'type' => 'Part', 'stok' => 10]);
            $this->seedProduct(['id_product' => 8002, 'type' => 'Part', 'stok' => 10]);
            ...
            $resp = (new TransaksiController())->CustomTransaction('8001-8002', $req);
