...
namespace Tests\Unit\Controllers {
    ...
    class ViewProductAdminTest extends BaseControllerTestCase
    {
     ...
     * =========================================================== */
        ...
        public function test_TestCase_130_viewProductAdmin_returns_view_isNull_0_when_product_exists()
        {
            $this->mockAllViews();
            ...
            $this->seedProduct(['id_product' => 77, 'type' => 'Product']);
            $this->seedPhoto(['id_Photo' => 77, 'id_product' => 77]);
            DB::table('products')->where('id_product', 77)->update(['mainPhoto' => 77]);

            $resp = (new ProductsController())->ViewProductAdmin(77);
            $this->assertStringContainsString('view:/User.Admin.viewProduct', (string)$resp->getContent());
        }
    }
}