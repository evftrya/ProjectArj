...
namespace Tests\Unit\Controllers {
    ...
    class updateIDTransactionTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_102_updateIDTransaction_updates_all_rows_with_transaksis_id_3_to_new_id()
        {
            ...
            $this->seedTransaksi(['id' => 3, 'id_user' => 2]);

            $this->insertCaseSafe('detail__transactions', [
                'id_Detail_transaction' => 801,
                'id_User' => 2,
                'id_product' => 5,
                'qty' => 1,
                'Total' => 10000,
            ...
            $this->seedTransaksi(['id' => 99, 'id_user' => 2]);

            (new DetailTransactionController())->updateIDTransaction(3, 99);

            $row = DB::table('detail__transactions')->where('id_Detail_transaction', 801)->first();
            $this->assertSame(99, (int)$row->Transaksis_id);
        }
    }
}