...
namespace Tests\Unit\Controllers {
    ...
    class getAllDataNonDeleteTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_081_getAllDataNonDelete_filters_isDelete_no()
        {
            $this->requiresTablesOrSkip(['users'], 'users table required');

            $this->seedUser(['id_User' => 2, 'isDelete' => 'no', 'emailUser' => 'a@a.com']);
            $this->seedUser(['id_User' => 3, 'isDelete' => 'yes', 'emailUser' => 'b@a.com']);

            $rows = (new AccountController())->getAllDataNonDelete();
