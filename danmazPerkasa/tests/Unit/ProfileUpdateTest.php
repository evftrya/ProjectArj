...
namespace Tests\Unit\Controllers {
    ...
    class ProfileUpdateTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_091_ProfileUpdate_delegates_to_account_update()
        {
            $this->requiresTablesOrSkip(['users'], 'users table required');

            $uid = $this->seedUser(['id_User' => 2, 'namaUser' => 'Old Name']);
            ...
            $resp = (new BaseController())->ProfileUpdate($req, new AccountController(), 'Info');
