...
namespace Tests\Unit\Controllers {
    ...
    class getCityTest extends BaseControllerTestCase
    {
        /* ===========================================================
     ...
     * =========================================================== */
        ...
        public function test_TestCase_092_getCity_returns_json_when_logged_in()
        {
            $this->requiresTablesOrSkip(['cities'], 'cities table required');

            $this->setSession(['user_id' => 2]);

            $this->insertCaseSafe('cities', [
                'city_id' => 10,
                'province_id' => 1,
                'city_name' => 'Bandung',
            ]);

            $resp = (new BaseController())->getCity(1);
