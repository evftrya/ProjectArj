    ...
    <body>
        <div class="allert" id="theAllert" style="display:none;">
            ...
            <div class="allertButton">
                <button class="btn-pointer"  id="buttonAllert" onclick="allert(null,'close')">Ok</button>
                ...
                <form action="/RegistrationAccount" method="POST">
                    ...
                    <div class="input-container" id="PasswordArea">
                        ...
                        <div class="ButtonArea">
                            <button class="btn-pointer"  id="See" onclick="Password('LetsSee')">
                            ...
                            <button class="btn-pointer"  id="UnSee" onclick="Password('LetsUnSee')">
                    ...
                    <button class="btn-pointer"  class="buttonForm" id="buttonForm" onclick="Regis(event, this)">
                        <p>Register</p>
                    </button>
