    ...
    <body>
        <div class="allert" id="theAllert" style="display:none;">
            ...
            <div class="allertButton">
                <button class=""  id="buttonAllert" onclick="allert(null,'close')">Ok</button>
                ...
                <form action="/RegistrationAccount" method="POST">
                    ...
                    <div class="input-container" id="PasswordArea">
                        ...
                        <div class="ButtonArea">
                            <button class=""  id="See" onclick="Password('LetsSee')">
                            ...
                            <button class=""  id="UnSee" onclick="Password('LetsUnSee')">
                    ...
                    <button class=""  class="buttonForm" id="buttonForm" onclick="Regis(event, this)">
                        <p>Register</p>
                    </button>
