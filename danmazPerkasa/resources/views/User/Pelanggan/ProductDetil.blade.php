        ...
        <div class="ActionArea">
            ...
            <div class="ProductQty">
                ...
                <div class="qtynumbers {{{$product->stok!=0?'':'Fade'}}}">
                    <button class=""  class="start minus" {{{($product->stok==0||(session('isActive')=='nonActive'))?'disabled':''}}}>
                    ...
                    <button class=""  class="end plus" {{{($product->stok==0||(session('isActive')=='nonActive'))?'disabled':''}}}>
            ...
            <div class="buttonArea">
                <!-- <form action=""></form> -->
                @if(session('user_id')==0)
                <button class=""  onclick="toLogin(event)" style="margin-left:50px; background-Color: #B17457;color: white;">
                    Login to Buy
                </button>
                @else
                <button class=""  class="atc" onclick="AddToCart(this, '{{{$product->id_product}}}',event)" {{{($product->stok==0||(session('isActive')=='nonActive'))?'disabled':''}}}>
                    <p>Add To Cart</p>
                </button>

                <button class=""  class="co" onclick="goCheckout('{{{$product->id_product}}}',event)" {{{($product->stok==0||(session('isActive')=='nonActive'))?'disabled':''}}}>
                    <p>Checkout</p>
                </button>
                @endif
